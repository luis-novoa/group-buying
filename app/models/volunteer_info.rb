class VolunteerInfo < ApplicationRecord
  ...
  validates :facebook, allow_nil: true, length: { maximum: 75 }
  validates :instagram, allow_nil: true, length: { maximum: 75 }
  validates :lattes, allow_nil: true, length: { maximum: 75 }
